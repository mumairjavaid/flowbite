...
const Flowplan = () => {
  return (
    <section className="bg-white mt-5 dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        ...
        <button
          type="button"
          className="flex justify-center items-center dark:text-gray-400 underline underline-offset-4 mx-auto font-medium text-primary-600 dark-text-primary-400 hover:text-primary-700"
        ...
        <div
          id="detailed-pricing"
          className="hidden overflow-x-auto mt-8 w-full"
        >
