...
const Heronav = () => {
  return (
    <section className="bg-[url('https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/coast-house-view.jpg')] mt-[88px] p-4 bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply ">
